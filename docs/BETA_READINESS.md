...
`generateLink`'s `redirectTo` is rejected. Both are done as of Build Order step 82–83. The hosted magic-link email is also branded and
routed through Resend custom SMTP as of step 84 (verified end-to-end). Nothing here is
outstanding.
