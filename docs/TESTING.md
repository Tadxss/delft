...
| `csp.spec.ts`                 | The `Content-Security-Policy-Report-Only` header is present on public + app routes; a walk through the BlockNote editor, Excalidraw canvas, and credentials vault produces zero CSP violations (validates the allowlist before it's flipped to enforcing).                                                                                                                                                                                                                                                                                                                                                                                                |
