...
// Every authenticated-only route (app/workspace/, app/account/) uses this. Delft's auth is fully
...
// session" is a minor cosmetic cost, not a real access-control gap (every actual read/write is
// still enforced by RLS regardless of what the client renders).
