...
// Three variants matching what's actually used today, not a from-scratch design: `primary` is the
...
// `ghost` deliberately keeps its own compact padding rather than sharing primary/secondary's
// px-3 py-2 — icon buttons size themselves to their icon, not to a text button's scale — so
// callers pass `className` to adjust that per context, same as before this component existed.
