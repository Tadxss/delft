...
// TEMPORARY diagnostic — delete this whole directory once it's been used. Test-decrypts every
// credential row against a typed passphrase directly, independent of the (possibly stale)
// vault_verifier check, to confirm whether the passphrase itself is fine and only the verifier is
// out of sync. Passphrase never leaves the browser. Only pass/fail counts + failing ids are shown,
// never decrypted plaintext, so it's safe to have on screen.
